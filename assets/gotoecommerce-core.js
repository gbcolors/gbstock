  ...
  function mount(target, config) {
    ...
    function renderShell() {
      root.innerHTML = [
        ...
        '<section class="ge-specimen"><div class="ge-section-head"><div><p class="ge-eyebrow">Adebayo / stock display</p><h2>Familia completa para revision</h2></div><span class="ge-count">OTF / TTF / WOFF2</span></div><div class="ge-specimen-word" style="font-family:' + safe(config.displayFontFamily || "GBstock Plus Display") + ', Inter, sans-serif;">stock</div><div class="ge-specimen-lines" style="font-family:' + safe(config.displayFontFamily || "GBstock Plus Display") + ', Inter, sans-serif;"><p>abcdefghijklmnopqrstuvwxyz</p><p>ABCDEFGHIJKLMNOPQRSTUVWXYZ</p><p>0123456789 . - / &</p><p>Sans Serif Italicas Cursivas Display Gratis</p></div></section>',
    ...
    function renderFontRow(product) {
      ...
      var fontFamily = product.previewWoff2 ? product.id : (config.displayFontFamily || "GBstock Plus Display");
